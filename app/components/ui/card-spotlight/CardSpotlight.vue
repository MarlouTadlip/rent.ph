...
<template>
  <div class="group relative flex size-full overflow-hidden bg-white/0 backdrop-blur-md dark:bg-neutral-900/70"
    :class="[$props.class]" @mousemove="handleMouseMove" @mouseleave="handleMouseLeave">
