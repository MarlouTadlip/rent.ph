...
<template>
  ...
  <div
    class="relative flex h-50 w-screen flex-col items-center justify-center overflow-hidden mb-5 gap-y-5"
  >
    <Marquee pause-on-hover class="[--duration:20s]">
      <ReviewCard
        ...
        :key="review.img"
        :img="review.img"
        class="cursor-pointer transition-transform hover:scale-105 bg-white"
